<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24 bg-white border border-blue-200 shadow-md rounded-xl">
        ...
        <form method="POST" action="/listings/{{ $listing->id }}" enctype="multipart/form-data" class="space-y-6">
            ...
            {{-- Website --}}
            <div>
                <label for="website" class="block text-sm font-medium text-gray-700 mb-1">Website/Application URL</label>
            ...
            <div class="flex items-center justify-between">
                <button class="bg-blue-600 hover:bg-blue-700 text-white font-semibold -mt-4 py-2 px-6 rounded-lg transition">
                    Update Job
                </button>
            </div>
        </form>
